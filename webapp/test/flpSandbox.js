		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#employeestore-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employeestore-display": {
								"semanticObject": "employeestore",
								"action": "display",
								"description": "Virtual Store for Employees",
								"title": "Employee Store",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeestore",
									"url": sap.ui.require.toUrl("employeestore")
								}
							}
						}
					}
